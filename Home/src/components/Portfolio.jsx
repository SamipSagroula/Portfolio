...
const AnimatedRole = () => {
  ...
  const roles = ['Software Engineer', 'Game Developer'];
  ...
  return (
    <div className="relative h-20 sm:h-24 overflow-hidden">
      {roles.map((role, i) => (
        <div
          key={role}
          className={`absolute inset-0 transition-all duration-700 ${i === index
...
const FadeIn = ({ children, delay = 0, className = '' }) => {
  ...
  return (
    <div
      ref={domRef}
      className={`transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0 blur-0' : 'opacity-0 translate-y-12 blur-sm'
        } ${className}`}
  ...
  const projects = [
    {
      ...
      description: 'A restaurant recommendation website that helps users discover restaurants based on their preferred cuisines, food tastes, ratings, and location. The platform allows users to explore restaurant information online.',
    ...
    type: 'video',
      title: 'Sentinel',
        mediaPath: '/FinalInsta.mp4',
          description: 'A passion project where I built a 3D action game using Unreal Engine. I spent a lot of time tinkering with the lighting, physics, and writing some tricky AI behaviors for enemy encounters.',
  ...
  <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex items-center justify-between">
          <a href="#home" className="flex items-center gap-3 group">
            ...
            <span className="font-bold text-lg hidden sm:block">Samip<span className="text-cyan-400"> Sangroula</span></span>
          </a>
          ...
          <nav className="hidden md:flex items-center gap-1 bg-white/5 border border-white/10 p-1.5 rounded-full backdrop-blur-sm">
            {['home', 'skills', 'projects', 'contact'].map((item) => (
              <a
                key={item}
                href={`#${item}`}
                className={`px-5 py-2 text-sm font-medium rounded-full transition-all duration-300 ${activeSection === item
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <FadeIn delay={400}>
            <p className="text-xl sm:text-2xl text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed">
              Hey, I build web apps and games. I love bringing ideas to life through code and creating digital tools that people actually enjoy using. Let's make something cool together!
            </p>
          </FadeIn>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <div className="text-center mb-20">
            <h2 className="text-sm font-bold text-cyan-400 uppercase tracking-widest mb-4">My Stack</h2>
            <h3 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              Tools I <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">Love</span>
            </h3>
    ...
    <section id="projects" className="py-32 relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <div className="text-center mb-20">
            <h2 className="text-sm font-bold text-cyan-400 uppercase tracking-widest mb-4">What I've Built</h2>
          ...
          <FadeIn>
            <div className="text-center mb-16">
              ...
              <p className="text-gray-400 text-lg">
                Got an idea or a project in mind? Reach out and say hi!
              </p>
            </div>
          </FadeIn>
